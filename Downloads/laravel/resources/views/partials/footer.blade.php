        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-bold">{{ __('site.name') }}</span>
                </div>
                <div class="flex items-center gap-6">
                    ...
                    <a href="https://www.instagram.com/astanatv.kz?igsh=MThpaGtyeDZ1aHk5bQ==" class="text-gray-400 hover:text-white transition flex items-center gap-2">
                    ...
                    <a href="https://youtube.com/@astanatv8263?si=WrWdthnT4QlE5D7z" class="text-gray-400 hover:text-white transition flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    @foreach(\App\Models\Category::active()->ordered()->get() as $cat)
                        <li>
                            <a href="{{ route('news.category', $cat->slug) }}" class="text-gray-400 hover:text-white transition flex items-center gap-2">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li>
                        <a href="#" class="hover:text-white transition">{{ __('about.title') }}</a>
                    </li>
                    <li>
                        <a href="#" class="hover:text-white transition">{{ __('footer.advertising') }}</a>
                    </li>
                    <li>
                        <a href="#" class="hover:text-white transition">{{ __('footer.privacy') }}</a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-400">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:newsportal@news.kz" class="hover:text-white transition">newsportal@news.kz</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <a href="tel:+77773171919" class="hover:text-white transition">+7 (777) 317-19-19</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span>{{ __('footer.working_hours') }}</span>
                    </li>
                </ul>
            </div>
        </div>
